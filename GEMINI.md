# GEMINI — Adaptateur agent

> **Statut :** `APPLICABLE`  
> **Autorité :** `AGENTS.md` et `GOVERNANCE.md`.

Gemini doit commencer par `00_START_HERE.md`, puis lire intégralement `GOVERNANCE.md`, `AGENTS.md`, `SOURCE_OF_TRUTH.md` et les documents canoniques et spécialisés concernés. Ce fichier ne duplique pas la politique métier afin d’éviter les divergences.
